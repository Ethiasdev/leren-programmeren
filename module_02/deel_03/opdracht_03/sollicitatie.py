...
praktijk = int(
    input("Hoeveel jaar heeft u praktijkervaring met dieren-dressuur?:"))
diploma = input("Bent u in bezit van een Diploma MBO-4 ondernemen? ja/nee:")
rijbewijs = input(
    "Bent u in bezit van een geldig Vrachtwagen rijbewijs? ja/nee:")
...
certificaat = input(
    "Heeft u een overleven met een gevaarlijk persoon certificaat? ja/nee:")
